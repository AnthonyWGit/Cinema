...
CREATE TABLE IF NOT EXISTS `film` (
  `id_film` int NOT NULL,
  `titre_film` varchar(200) CHARACTER SET utf32 COLLATE utf32_swedish_ci NOT NULL,
  `duree_film` int NOT NULL,
  `dateSortie_film` year NOT NULL,
  `image_film` varchar(50) CHARACTER SET utf32 COLLATE utf32_swedish_ci DEFAULT NULL,
  `note_film` decimal(2,1) DEFAULT NULL,
  `synopsis` text CHARACTER SET utf32 COLLATE utf32_swedish_ci,
...
REPLACE INTO `film` (`id_film`, `titre_film`, `duree_film`, `dateSortie_film`, `image_film`, `note_film`, `synopsis`, `id_realisateur`) VALUES
...
CREATE TABLE IF NOT EXISTS `genre` (
  ...
  `nom_genre` varchar(50) CHARACTER SET utf32 COLLATE utf32_swedish_ci NOT NULL,
...
-- Listage des données de la table cinema.genrer : ~53 rows (environ)
REPLACE INTO `genrer` (`id_film`, `id_genre`) VALUES
	(1, 0),
	(11, 0),
	(13, 0),
	(15, 0),
...
CREATE TABLE IF NOT EXISTS `personne` (
  ...
  `prenom` varchar(50) CHARACTER SET utf32 COLLATE utf32_swedish_ci NOT NULL,
...
REPLACE INTO `personne` (`id_personne`, `nom`, `prenom`, `dateDeNaissance`, `sexe`) VALUES
...
CREATE TABLE IF NOT EXISTS `role` (
  `id_role` int NOT NULL,
  `nom_role` varchar(50) CHARACTER SET utf32 COLLATE utf32_swedish_ci NOT NULL,
  PRIMARY KEY (`id_role`)
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_swedish_ci;
